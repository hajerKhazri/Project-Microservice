...
import com.example.serviceprojet.service.IProjetService;
...
public class ProjetController {
    ...
    @GetMapping("/projet-with-reviews/{id}")
    public ResponseEntity<Projet> getProjetWithReviews(@PathVariable Long id) {
        try {
            Projet projet = projetService.getProjetWithReviews(id);
